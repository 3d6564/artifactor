...
def get_processes(host, jumpbox, jumpbox_username, jumpbox_key_path, target_username, target_key_path):
    return run_command_on_host('ps aux', host, jumpbox, jumpbox_username, jumpbox_key_path, target_username, target_key_path)

def get_users(host, jumpbox, jumpbox_username, jumpbox_key_path, target_username, target_key_path):
